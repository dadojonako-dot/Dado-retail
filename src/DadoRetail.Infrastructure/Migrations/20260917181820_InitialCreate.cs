        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderReceiptId = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_fiscal_transactions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    BookQuantity = table.Column<decimal>(type: "numeric(18,3)", precision: 18, scale: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_inventory_lines_inventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_fiscal_transactions_SaleId",
                table: "fiscal_transactions",
                column: "SaleId");

            migrationBuilder.CreateIndex(
                name: "IX_inventories_WarehouseId_Number",
                table: "inventories",
                columns: new[] { "WarehouseId", "Number" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_inventory_lines_InventoryId_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_prices_StoreId_ProductId_ValidFromUtc",
                table: "prices",
                columns: new[] { "StoreId", "ProductId", "ValidFromUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sale_return_items_SaleReturnId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_stock_movements_DocumentId",
