...
{
    private Sale() { }
    public Sale(Guid storeId, Guid warehouseId, Guid cashRegisterId, Guid cashierId)
    { StoreId = storeId; WarehouseId = warehouseId; CashRegisterId = cashRegisterId; CashierId = cashierId; }
